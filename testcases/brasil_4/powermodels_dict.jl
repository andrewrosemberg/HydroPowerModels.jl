...
function gen_dict(; name = nothing,
...
function branch_dict(; name = nothing,
    ...
    branch = Dict{String,Any}("br_r"=> br_r,
        "rate_a"=> rate_a,
        "shift"=> shift,
        "br_x"=> br_x,
        "g_to"=> g_to,
...
function bus_dict(; name = nothing,
...
function load_dict(;
    ...
    lod = Dict{String,Any}( "load_bus"=> load_bus,
        "status"=> status,
        "qd"=> qd,
        "pd"=> pd,
        "index"=> index)
...
function _powermodels_dict_(; bus::Dict{String,Dict{String,Any}}= Dict{String,Dict{String,Any}}(),
...
function powermodels_dict(;bus::Array{Dict{String,Any}}= Array{Dict{String,Any}}(undef,0),
    source_type::String= "matpower",
    name = "CaseX",    
    cost_deficit = 1000,
    dcline::Dict{String,Any}= Dict{String,Any}(),
    ...
    pm = _powermodels_dict_(bus= Dict(Pair.(string.(collect(1:size(bus,1))) , bus)),
        source_type= source_type,
        name= name,
        cost_deficit = cost_deficit,
        dcline= dcline,
