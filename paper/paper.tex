...
% <review @frapac>
% I recommend to cite "Bertsekas, Dynamic Programming and optimal control"  when first refering
% to Stochastic Dynamic Programming. Citing the seminal article of Richard Bellman
...
% <review @frapac>
% 1/ I would cite the book of Ruczinsky, Dentcheva and Shapiro when
%    first refering to Stochastic Programming.
% 2/ I would rephrase the first sentence as:
%   "where the value of random variables" -> "where the realization of some
%   random variables"
% </review>
...
% <review @frapac>
% I would be more specific about what a policy is. Maybe introduce the
% notation $u_t = \pi_t(x_t)$ to emphasize the fact that $\pi_t$ is a mapping
% from a state to a decision $u$.
% </review>
...
% <review @frapac>
% "dynamic programming~\cite{bellman1957}"
% </review>
...
% <review @frapac>
% I would explicitly emphasized that we obtain a non-linear non-convex
% optimization problem in (1), thus leading to some difficulties in
% SDDP (as the convexity assumption is broken).
% </review>
...
% <review @frapac>
% I would put the reference [13] in this paragraph.
% </review>
...
% <review @frapac>
% "The effect of these assumptions..." -> I would rephrase this sentence
% </review>
...
% <review @frapac>
% "through mathematical" -> "through mathematically guaranteed"
% </review>
...
% <review @frapac>
% "product of the voltage variables" -> "bilinear product of the voltage variables"
% </review>
...
% <review @frapac>
% I would emphasize here that all these relaxations are convex, thus suitable
% for using SDDP!
% </review>
...
% <review @frapac>
% "paid professional product" -> "commercial solvers"
% </review>
...
% <review @frapac>
% Here some references are not valid, as:
% [1] (seems related to some issues with the bibtex)
% [10] Is Leopold Cambier involved in StructDualDynProg? I would rather use the url to the github package...
% </review>
\input{bib.tex}
