...
alldata = HydroPowerModels.parse_folder(joinpath(testcases_dir,"case3deterministic_overwater"))
...
########################################
# objective
@test isapprox(sum(s[:stage_objective] for s in results[:simulations][1]),6016.68, atol=1e-2)
